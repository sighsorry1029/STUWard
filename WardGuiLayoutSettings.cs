...
internal static class WardGuiLayoutSettings
{
    ...
    internal static Vector2 GetWarningSoundLabelPosition() => new(-140f, 57f);
    internal static Vector2 GetWarningSoundTogglePosition() => new(-210f, 40f);
    internal static Vector2 GetWarningFlashLabelPosition() => new(110f, 57f);
    internal static Vector2 GetWarningFlashTogglePosition() => new(40f, 40f);
